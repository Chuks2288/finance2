...
//         const dwollarCustomerUrl = await createDwollaCustomer({
//             ...userData,
//             type: "personal"
//         });

//         if (!dwollarCustomerUrl) throw new Error("error creating dwolla customer");

//         const dwollaCustomerId = extractCustomerIdFromUrl(dwollarCustomerUrl);
